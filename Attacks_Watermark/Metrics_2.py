...
attack_images_paths = [
    'watermarked_BACT-03_ROT_45.bmp', 
    'watermarked_BACT-03_RNDDIST_0.95.bmp', 
    'watermarked_BACT-03_PSNR_90.bmp',
    'watermarked_BACT-03_NOISE_40.bmp',
    'watermarked_BACT-03_NOISE_20.bmp',
    'watermarked_BACT-03_MEDIAN_9.bmp',
    'watermarked_BACT-03_JPEG_90.bmp',
    'watermarked_BACT-03_CROP_75.bmp',
    'watermarked_BACT-03_CONV_1.bmp',
    'watermarked_BACT-03_AFFINE_3.bmp',
    'blurred.bmp',
    'bending_attack.bmp',
    'attacked_salt_pepper.bmp',
    'attacked_gaussian_blur.bmp'
]  # Add more paths as needed

# Iterate over each attack image
for attack_image_path in attack_images_paths:
    ...
    # Extract the attack name from the file name (without extension)
    attack_name = os.path.splitext(os.path.basename(attack_image_path))[0]
